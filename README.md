...
> ⚠️ **Single source of truth lives in [Lovable](https://vocab.voyage).**
> Every file in this folder is regenerated by `pnpm release:check` →
> `scripts/build-mcp-repo.mjs`. Do not hand-edit; PRs that modify these
> files will be closed and applied upstream instead.
